...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue, SelectGroup } from '@lib/components/ui/select';
...
const PriceCalculator = () => {
  ...
  // Вычисление финальных цен с учетом выбранных опций
            ...
            <SelectContent>
              <SelectGroup>
                <SelectItem value="glossy">
                  Глянсова (A6- +0грн/шт, А5 - +0грн/шт, A4- +0грн/шт, А3 - +0грн/шт)
                </SelectItem>
